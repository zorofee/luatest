...
void main ()
{
  ...
  lowp vec4 tmpvar_5;
  tmpvar_5 = texture (_PrevTexture, xlv_TEXCOORD0);
  lowp vec4 tmpvar_6;
  tmpvar_6 = texture (_NextTexture, xlv_TEXCOORD0);
  lowp vec2 tmpvar_7;
  ...
  tmpvar_9 = texture (_PrevTexture, P_10);
  lowp vec4 tmpvar_11;
  highp vec2 P_12;
  P_12 = (xlv_TEXCOORD0 - (offset_2 * (1.0 - _Progress)));
  tmpvar_11 = texture (_NextTexture, P_12);
