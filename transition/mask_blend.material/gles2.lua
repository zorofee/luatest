...
void main ()
{
  lowp vec4 tmpvar_1;
  lowp vec4 tmpvar_2;
  tmpvar_2 = texture2D (_MaskTexture, xlv_TEXCOORD0);
  tmpvar_1 = ((texture2D (_PrevTexture, xlv_TEXCOORD0) * (1.0 - tmpvar_2.x)) + (texture2D (_NextTexture, xlv_TEXCOORD0) * tmpvar_2.x));
