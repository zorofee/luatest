...
void main ()
{
  ...
  if ((tmpvar_6 < 0.5)) {
    ...
    for (highp int i_1_12 = 1; i_1_12 <= 15; i_1_12++) {
      ...
      sum_16 = (sum_16 + (texture2D (_PrevTexture, tmpvar_22).xyz * half_gaussian_weight_18[i_1_12]));
      sum_16 = (sum_16 + (texture2D (_PrevTexture, tmpvar_24).xyz * half_gaussian_weight_18[i_1_12]));
    ...
    lowp vec3 tmpvar_37;
    tmpvar_37 = (texture2D (_NextTexture, tmpvar_26).xyz * half_gaussian_weight_35[0]);
    ...
    for (highp int i_1_29 = 1; i_1_29 <= 15; i_1_29++) {
      ...
      sum_33 = (sum_33 + (texture2D (_NextTexture, tmpvar_39).xyz * half_gaussian_weight_35[i_1_29]));
      sum_33 = (sum_33 + (texture2D (_NextTexture, tmpvar_41).xyz * half_gaussian_weight_35[i_1_29]));
