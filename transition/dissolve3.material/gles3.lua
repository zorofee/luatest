...
void main ()
{
  ...
  lowp vec4 sColor1_5;
  lowp vec4 tmpvar_6;
  tmpvar_6 = texture (_PrevTexture, xlv_TEXCOORD0);
  sColor1_5 = tmpvar_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture (_NextTexture, xlv_TEXCOORD0);
  sColor2_4 = tmpvar_7;
  ...
  lowp vec4 tmpvar_19;
  tmpvar_19 = texture (_NextTexture, res_uv_12);
  lowp float tmpvar_20;
  tmpvar_20 = dot (min (tmpvar_19, texture (_PrevTexture, res_uv_16)).xyz, vec3(0.299, 0.587, 0.114));
  gray_2 = tmpvar_20;
  gray_2 = (gray_2 * 2.0);
