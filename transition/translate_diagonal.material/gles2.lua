...
void main ()
{
  ...
  if ((tmpvar_5 <= 0.5)) {
    ...
    for (highp int i_11 = -8; i_11 <= 8; i_11++) {
      ...
      color_12 = (color_12 + texture2D (_PrevTexture, newCoord_14).xyz);
    };
    ...
    if (((tmpvar_5 > 0.5) && (tmpvar_5 <= 1.0))) {
      ...
      for (highp int i_20 = -8; i_20 <= 8; i_20++) {
        ...
        color_21 = (color_21 + texture2D (_NextTexture, newCoord_23).xyz);
      };
      color_21 = (color_21 / 17.0);
      result_2 = color_21;
    } else {
      if ((tmpvar_5 > 1.0)) {
        result_2 = texture2D (_NextTexture, xlv_TEXCOORD0).xyz;
      };
    };
  };
  lowp vec4 tmpvar_25;
