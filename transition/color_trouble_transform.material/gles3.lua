...
void main ()
{
  ...
  if ((_Progress >= 0.5)) {
    ...
    time_7 = tmpvar_10;
    lowp vec4 tmpvar_11;
    tmpvar_11 = texture (_NextTexture, xlv_TEXCOORD0);
    ...
    for (highp float i_4 = 0.0; i_4 <= (10.0 * amount_8); i_4 += 1.0) {
      ...
      if ((tmpvar_16 == 1.0)) {
        ...
        uvOff_17 = tmpvar_20;
        lowp vec4 tmpvar_21;
        tmpvar_21 = texture (_NextTexture, tmpvar_20);
    ...
    if ((tmpvar_30 < 0.33)) {
      lowp vec4 tmpvar_31;
      tmpvar_31 = texture (_NextTexture, tmpvar_28);
      color_6.x = tmpvar_31.x;
    } else {
      if ((tmpvar_30 < 0.66)) {
        lowp vec4 tmpvar_32;
        tmpvar_32 = texture (_NextTexture, tmpvar_28);
        color_6.y = tmpvar_32.y;
      } else {
        lowp vec4 tmpvar_33;
        tmpvar_33 = texture (_NextTexture, tmpvar_28);
    ...
    time_40 = tmpvar_43;
    lowp vec4 tmpvar_44;
    tmpvar_44 = texture (_PrevTexture, xlv_TEXCOORD0);
    ...
    for (highp float i_37 = 0.0; i_37 <= (10.0 * amount_41); i_37 += 1.0) {
      ...
      if ((tmpvar_49 == 1.0)) {
        ...
        uvOff_50 = tmpvar_53;
        lowp vec4 tmpvar_54;
        tmpvar_54 = texture (_PrevTexture, tmpvar_53);
    ...
    if ((tmpvar_63 < 0.33)) {
      lowp vec4 tmpvar_64;
      tmpvar_64 = texture (_PrevTexture, tmpvar_61);
      color_39.x = tmpvar_64.x;
    } else {
      if ((tmpvar_63 < 0.66)) {
        lowp vec4 tmpvar_65;
        tmpvar_65 = texture (_PrevTexture, tmpvar_61);
        color_39.y = tmpvar_65.y;
      } else {
        lowp vec4 tmpvar_66;
        tmpvar_66 = texture (_PrevTexture, tmpvar_61);
